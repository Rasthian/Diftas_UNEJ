...
<body class = "font-[Segoe UI]">
    ...
    <div class="profile-container">
        ...
        <div class="content-profile">
            ...
            <a href="#" onclick="confirmLogout()" class="bg-blue-400 p-2 text-white text-center rounded-lg">
                Logout
            </a>
            <form action="?action=deleteAccount" class="bg-red-500 p-2 text-white text-center rounded-lg" method="post" id="deleteAccountForm">
    ...
    <footer class="flex border-b-2 bg-blue-400 items-center h-[200px]">
        <div class='flex pl-5 pr-5 mx-auto w-[640px] sm:w-[640px] md:w-[760px]  lg:w-[1000px] xl:w-[1280px] 2xl:w-[1920px] md:text-2xl font-medium placeholder justify-between' style='background-color:rgb(96 165 250); cursor:unset;'>
