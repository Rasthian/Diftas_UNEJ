        ...
        <div class='grid grid-cols-[1fr,2fr,1fr]'>
            ...
            <div class='tengah border-r '>
                ...
                <?php if(empty($diskusi)){
                                echo "<h1 class='font-bold text-blue-400 text-center text-4xl'>Belum ada diskusi yang dibuat</h1>";
                            } ?>
              
                <?php foreach ($diskusi as $diskusi) : ?>
                    <a href="index.php?action=showdiskusi&id=<?= $diskusi['id']; ?>" class='flex justify-center items-center mt-7'>
                        <div class='bg-white w-[900px] rounded-lg'>
                            <div class='header m-5'>
                                <p class='text-neutral-800 text-xl font-bold'><div class="header-diskusi flex justify-between"><?= $diskusi['nama'] ?></div></p>
