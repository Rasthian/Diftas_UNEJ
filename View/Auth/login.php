...
<body>
    ...
    <form class="form-container h-screen w-full md:w-1/2 p-8" action="?action=login" method="post" role="form">
        ...
        <div class="mt-2 md:mt-10 flex flex-col">
            ...
            <input value="" name="nim"  class="outline-none w-full md:w-4/5 h-10 bg-slate-100 rounded-sm mt-2" type="text"
                placeholder="Masukkan username anda">
        </div>
        <div class="mt-2 flex flex-col">
            <label class="font-bold text-blue-700" for="Password">Password</label>
            <input name="password" class="outline-none w-full md:w-4/5 h-10 bg-slate-100 rounded-sm mt-2" type="password"
        ...
        <a href="?action=register"><p class="flex flex-col items-center text-blue-700 mt-3">Buat akun jika belum punya</p></a>
